...
TESTPMD_PARAMS="--burst=64 -i --txd=2048 --rxd=2048 --port-topology=chained --eth-peer=0,$1 --forward-mode=macswap --auto-start"
...
DPDK_PARAMS="-c 0x06 -l 3,4 -n 1 --socket-mem 512 --file-prefix testpmd --pci-whitelist 00:0b.0"
